...
import com.telenav.jeff.concur.service.ConcurService;
import com.telenav.jeff.concur.service.TokenManager;
...
public class TokenService extends ConcurService
{
    ...
    public void requestToken(String code)
    {
        ...
        try
        {
            ...
            reader.setContentHandler(new AuthResponseHandler());
